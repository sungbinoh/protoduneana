...
#ifndef protoDUNE_X_calib_Birks_h
#define protoDUNE_X_calib_Birks_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   protoDUNE_X_calib_Birks(TTree *tree=0);
   virtual ~protoDUNE_X_calib_Birks();
...
#ifdef protoDUNE_X_calib_Birks_cxx
protoDUNE_X_calib_Birks::protoDUNE_X_calib_Birks(TTree *tree) : fChain(0) 
{
...
protoDUNE_X_calib_Birks::~protoDUNE_X_calib_Birks()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t protoDUNE_X_calib_Birks::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t protoDUNE_X_calib_Birks::LoadTree(Long64_t entry)
{
...
void protoDUNE_X_calib_Birks::Init(TTree *tree)
{
...
Bool_t protoDUNE_X_calib_Birks::Notify()
{
...
void protoDUNE_X_calib_Birks::Show(Long64_t entry)
{
...
Int_t protoDUNE_X_calib_Birks::Cut(Long64_t entry)
{
...
#endif // #ifdef protoDUNE_X_calib_Birks_cxx
